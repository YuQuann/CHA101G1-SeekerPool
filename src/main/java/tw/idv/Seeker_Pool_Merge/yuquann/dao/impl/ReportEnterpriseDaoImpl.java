...
public class ReportEnterpriseDaoImpl implements ReportEnterpriseDao {
	...
	public ReportEnterpriseVo selectNumber(int reNo) {
		...
		String sql = "SELECT RE_NO,MEM_ID,COM_MEM_ID,RE_START_ITME,RE_STATUS,RE_RESULT,MEM_ACCOUNT,COM_NAME FROM REPORT_ENTERPRISE "
...
//				System.out.println("list : " + list);
	...
	public List<ReportEnterpriseVo> selectAll() {
		...
		String sql = "SELECT RE_NO,MEM_ID,MEM_ACCOUNT,COM_MEM_ID,COM_NAME,RE_START_TIME,RE_STATUS,RE_RESULT FROM REPORT_ENTERPRISE "
	...
	public ReportEnterpriseVo statusShow(int reNo) {
		...
		// 動態生成 SQL 查詢語句
		String sql = "SELECT RE_NO,MEM_ID,COM_MEM_ID,RJT_NO,RE_CONTENT,RE_UPLOAD,MEM_ACCOUNT,COM_NAME FROM REPORT_ENTERPRISE "
				+ "LEFT JOIN MEMBER ON REPORT_ENTERPRISE.MEM_ID = MEMBER.MEM_ID "
				+ "LEFT JOIN COMPANY_MEMBER ON REPORT_ENTERPRISE.COM_MEM_ID = COMPANY_MEMBER.COM_MEM_ID "
				+ "WHERE RE_NO = ?;";
