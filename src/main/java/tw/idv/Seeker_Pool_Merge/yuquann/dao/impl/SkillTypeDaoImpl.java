...
public class SkillTypeDaoImpl implements SkillTypeDao {
	...
	public List<SkillTypeVo> selectAll() {
		...
		String sql = "SELECT SK_NO,SK_TYPE,SK_NAME,SK_SEARCH_TIMES FROM skill_type ; ";
	...
	public SkillTypeVo skillEditShow(int skNo) {
		...
		String sql = "SELECT SK_NO,SK_TYPE,SK_NAME,SK_SEARCH_TIMES FROM skill_type WHERE SK_NO = ? ;";
		ResultSet rs = null;
		SkillTypeVo vo = new SkillTypeVo();
