...
import tw.idv.Seeker_Pool_Merge.yuquann.dao.impl.ReportEnterpriseDaoImpl;
import tw.idv.Seeker_Pool_Merge.yuquann.vo.ReportEnterpriseVo;

@WebServlet("/ReportEnterpriseForm")
@MultipartConfig(maxFileSize = 10 * 1024 * 1024, maxRequestSize = 10 * 1024 * 1024)
public class ReportEnterpriseForm extends HttpServlet {
...
//		System.out.println("imageRelativeUrl : " + imageRelativeUrl);
		...
		ReportEnterpriseDaoImpl dao = new ReportEnterpriseDaoImpl();
